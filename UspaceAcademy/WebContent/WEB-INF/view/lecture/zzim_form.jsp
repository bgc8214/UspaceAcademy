...
<a id="zzim" href="/UspaceAcademy/lecture/zzimLecture.do?page=${requestScope.page }&lectureNo=${requestScope.lecture.lectureNo }"><button id="charge">찜하기</button></a>&emsp;&emsp;&emsp;
<a href="/UspaceAcademy/lecture/lectureList.do?page=${requestScope.page }"><button id="cancel">강의목록</button></a><br>
