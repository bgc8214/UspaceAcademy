								...
								.on(
										...
										function() {
											if ($("#memberType").val() == "teacher") { // 마이페이지 강사 로그인
												$("#td6")
														.html(
																'<button>내 정보</button><button>내 강좌</button><a href="/UspaceAcademy/assignment/assignment_list.do"><button id="assignment">과제게시판</button></a><a href="/UspaceAcademy/lectureInquiry/lectureInquiryList.do"><button>강의 질문 게시판</button>');
												$("#td1").html("");
												$("#td5").html("");
