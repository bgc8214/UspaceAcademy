...
constraint fk_attendance_student foreign key (student_id2, lecture_no2) references student_lecture_join(student_id3, lecture_no3)
);
...
student_id varchar2(30) primary key, --학생아이디 primary key
student_password varchar2(30) not null, --비밀번호
...
lecture_description varchar2(500) not null, --강의 설명
...
lecture_subject varchar2(30) not null, --강의 종류
teacher_id2 varchar2(30), --강사아이디 foreign key
...
create table assignment_board(
	...
	assignment_content varchar2(4000) not null,
...
create table advanced_board(
	...
	advanced_content varchar2(4000) not null,
...
create table teacher(
	...
	teacher_phone_no varchar2(20) not null,
...
create table basic_board(
	...
	basic_content varchar2(4000) not null,	
