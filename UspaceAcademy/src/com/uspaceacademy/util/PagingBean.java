package com.uspaceacademy.util;
//notice
/**
 * 페이징 처리위한 bean <br>
 * page : 게시물 묶음
...
public class PagingBean {
	...
	public static void main(String[] args) {
		...
		//page내 게시물수 - 15
		//page그룹내 page수 - 10
		System.out.println("총 page 수 : "+d.getTotalPage()); // 201%15=14page
		System.out.println("총 page그룹 : "+d.getTotalPageGroup());// 14%10=2
		System.out.println("현 페이지 그룹 : "+d.getCurrentPageGroup());// 5%15=0.33333 -> 1page그룹
